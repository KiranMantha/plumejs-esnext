"use strict";(self.webpackChunkplumejs_esnext=self.webpackChunkplumejs_esnext||[]).push([[309],{1309:(e,t,o)=>{o.r(t);var n=o(6530),i=o(9546);function r(e,t){if(!Object.prototype.hasOwnProperty.call(e,t))throw new TypeError("attempted to use private field on non-instance");return e}var s=0;function l(e){return"__private_"+s+++"_"+e}const d={options:[],multiple:!1,defaultText:"Select",buttonText:null,enableFilter:!1,disable:!1,resetDropdown:!1};var a=l("detailsNode"),p=l("summaryNode"),c=l("optionsContainerNode"),u=l("summaryText"),h=l("isMultiSelect"),m=l("selectedOptions"),b=l("getSummaryText"),f=l("buildItems"),g=l("filterList"),w=l("onDropdownToggle");function v(){r(this,m)[m]=this.dropdownOptions.options.filter((function(e){return!!e.selected})),r(this,h)[h]?r(this,u)[u]=r(this,m)[m].map((function(e){return e.label})).join(",")||this.dropdownOptions.defaultText:r(this,m)[m].length?r(this,u)[u]=r(this,m)[m][0].label:(this.dropdownOptions.options[0].selected=!0,r(this,u)[u]=this.dropdownOptions.options[0].label)}function y(){var e=this;const t=this.dropdownOptions.options.map((function(t,o){return n.dy`
      ...
      `}));if(this.dropdownOptions.enableFilter){const o=n.dy` <li class="filter">
        ...
        >
          <summary
            ref=${function(t){r(e,p)[p]=t}}
          >
            ${r(this,u)[u]}
          </summary>
          <ul
            ref=${function(t){r(e,c)[c]=t}}
          >
            ${r(this,f)[f]()}
          </ul>
        </details>
      `:n.dy`<div></div>`}});var C=0;function $(e){return"__private_"+C+++"_"+e}var P=$("userInput"),j=$("dialogActions");class D{constructor(){var e=this;this.dialogRef=void 0,Object.defineProperty(this,P,{writable:!0,value:void 0}),Object.defineProperty(this,j,{writable:!0,value:void 0}),this.resolveDialogActions=void 0,this.resolveUserInput=void 0,k(this,P)[P]=new Promise((function(t){e.resolveUserInput=t})),k(this,j)[j]=new Promise((function(t){e.resolveDialogActions=t}))}showModal(){return this.dialogRef.showModal(),this.userInput}close(){this.dialogRef.close()}getUserInput(){return k(this,P)[P]}getDialogActions(){return k(this,j)[j]}}var T=$("modalClosedPromise"),A=$("resolveModalClose");function E(e,t){if(!Object.prototype.hasOwnProperty.call(e,t))throw new TypeError("attempted to use private field on non-instance");return e}(0,n.wA)({selector:"app-alert-dialog"},class extends D{constructor(){super(),this.ObservedProperties=["alertOptions"],this.alertOptions=void 0}onConfirm(){this.resolveUserInput(!0),this.dialogRef.close(),this.resolveDialogActions(!0)}onCancel(){this.resolveUserInput(!1),this.dialogRef.close(),this.resolveDialogActions(!0)}renderActionButtons(){var e=this;return this.alertOptions.isAlert?n.dy`
        <button
      ...
      `:n.dy``}}),(0,n.wA)({selector:"app-modal-dialog"},class extends D{constructor(){var e;super(),e=this,this.ObservedProperties=["modalData"],this.modalData=void 0,Object.defineProperty(this,T,{writable:!0,value:void 0}),Object.defineProperty(this,A,{writable:!0,value:void 0}),k(this,T)[T]=new Promise((function(t){k(e,A)[A]=t}))}afterClosed(){return k(this,T)[T]}onDialogClosed(){k(this,A)[A](),this.resolveDialogActions(!0)}renderCloseButton(){var e=this;return this.modalData.hideDefaultCloseButton?n.dy``:n.dy`
        <button
          class="btn-close"
      ...
      `:n.dy``}});var _=0;function B(e){return"__private_"+_+++"_"+e}const I={modalTitle:"",hideDefaultCloseButton:!1,preventBackdropClose:!0,preventEsc:!1,renderTemplate:function(){return n.dy``}};var R=B("createComponent"),S=B("removeComponent"),U=B("prompt");class L{constructor(){Object.defineProperty(this,U,{value:N}),Object.defineProperty(this,S,{value:F}),Object.defineProperty(this,R,{value:M})}alert(e){return E(this,U)[U](e,!0)}confirm(e){return E(this,U)[U](e,!1)}modal(e){var t=this;const o={...I,...e},i=E(this,R)[R]("app-modal-dialog",{modalData:{title:o.modalTitle,hideDefaultCloseButton:o.hideDefaultCloseButton,bodyTemplate:o.renderTemplate()}}),r=i.getInstance();if(r.showModal(),r.getDialogActions().then((function(e){e&&E(t,S)[S](i)})),!o.preventBackdropClose){const e=r.dialogRef.getBoundingClientRect(),t=(0,n.b9)(r.dialogRef,"click",(function(o){e.top<=o.clientY&&o.clientY<=e.top+e.height&&e.left<=o.clientX&&o.clientX<=e.left+e.width||(r.close(),t())}))}return o.preventEsc&&(0,n.b9)(r.dialogRef,"cancel",(function(e){e.preventDefault()})),{close:r.close.bind(r),afterClosed:r.afterClosed.bind(r)}}}function M(e,t){const o=document.createElement(e);return document.body.appendChild(o),o.setProps(t),o}function F(e){document.body.removeChild(e)}function N(e,t){var o=this;const n=E(this,R)[R]("app-alert-dialog",{alertOptions:{message:e,isAlert:t}}),i=n.getInstance();return i.showModal(),i.getDialogActions().then((function(e){e&&E(o,S)[S](n)})),{getUserInput:i.getUserInput.bind(i)}}(0,n.t6)(L);(0,n.wA)({selector:"app-controls",deps:[L]},class{constructor(e){this.dropdownComp=void 0,this.dropdownOptions={options:[{label:"Option 1",value:"o1"},{label:"Option 2",value:"o2",selected:!0},{label:"Option 3",value:"o3"},{label:"Option 4",value:"o4"}],multiple:!0,enableFilter:!0,defaultText:"Select Multiple",buttonText:function(e){return 0===e.length?"None selected":e.length>3?e.length+" selected":e.map((function(e){return e.label})).join(", ")}}}mount(){this.dropdownComp.setProps({dropdownOptions:this.dropdownOptions})}showAlert(){this.dialogService.alert("hello world").getUserInput().then((function(e){console.log(e)}))}showConfirm(){this.dialogService.confirm("hello world").getUserInput().then((function(e){console.log(e)}))}showModal(){this.dialogService.modal({modalTitle:"Hello World",hideDefaultCloseButton:!1,preventBackdropClose:!1,preventEsc:!1,renderTemplate:function(){return n.dy`<p>i'm inside a modal</p>`}}).afterClosed().then((function(){console.log("modal closed")}))}render(){var e=this;return n.dy`
