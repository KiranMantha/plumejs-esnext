import{Component,Service,html,render,registerRouterComponent,Renderer}from"./lib";import{Router}from"./lib/router";import{Observable}from"rxjs";import styles from"./base.scss";registerRouterComponent();class TestService{getGreeting(){return"hello world"}}class TestComponent{constructor(e){}emitDataToParent(){this.renderer.emitEvent("customoutput",{greet:"greetings from child"})}render(){var e=this;return html`
