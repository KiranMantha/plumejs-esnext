"use strict";(self.webpackChunkplumejs_esnext=self.webpackChunkplumejs_esnext||[]).push([[494],{1494:(e,t,s)=>{s.r(t);var a=s(1746),i=s(9669),l=s.n(i);(0,a.wA)({selector:"app-items",deps:["Renderer"]},class{constructor(e){this.sheetFormFields=void 0,this.changeHandler=void 0,this.resetForm=void 0,this.apiUrl="https://sheet.best/api/sheets/d406eddb-4e35-4496-a526-34fb27c763e4",this.table=void 0,this.personsList=[]}beforeMount(){[this.sheetFormFields,this.changeHandler,this.resetForm]=(0,a.uA)({name:"",age:"",salary:""})}mount(){this.getData()}submitForm(e){var t=this;e.preventDefault(),l().post(this.apiUrl,this.sheetFormFields).then((function(e){t.personsList.push(...e.data),t.resetForm(),t.renderer.update()}))}getData(){var e=this;l().get(this.apiUrl).then((function(t){e.personsList=[...t.data],e.renderer.update()}))}render(){var e=this;return a.dy`
      <form
