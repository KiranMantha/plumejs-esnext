"use strict";(self.webpackChunkplumejs_esnext=self.webpackChunkplumejs_esnext||[]).push([[518],{5518:(t,e,o)=>{o.r(e);var s=o(8975);(0,s.wA)({selector:"app-row-item",styles:":host {\n      display: table-row-group;\n  }\n  .hide-row {\n      display: none;\n  }\n  :host > tr > td[colspan] table {\n      margin: 0;\n  }\n  "},class{constructor(){this.ObservedProperties=["category"],this.category=void 0,this.nestedRow=void 0}toggleNestedTable(){this.nestedRow.classList.toggle("hide-row")}populateNestedTable(){return this.category.questions.length?this.category.questions.map((function(t){return s.dy`<tr>
      ...
      <table>
        <caption>Nested Table / Table with expandable rows</caption>
        <thead>
          <tr>
            <th>Category Id</th>
            <th>Category Name</th>
        ...
        ${this.categories.map((function(t){return s.dy`<app-row-item onbindprops=${function(){return{category:t}}}></app-row-item>`}))}
      </table>
    `}})}}]);