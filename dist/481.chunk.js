"use strict";(self.webpackChunkplumejs_esnext=self.webpackChunkplumejs_esnext||[]).push([[481],{449:(e,s,t)=>{t.r(s);var n=t(746);let o=["Renderer",class{constructor(e){this.personDetails=void 0}sendDataToParent(){this.renderer.emitEvent("userclick",this.personDetails)}render(){var e,s=this;return null!=(e=this.personDetails)&&e.name?n.dy`
        ...
        `:n.dy`
          <div></div>
        `}}];(0,n.wA)({selector:"app-persons"},class{constructor(){this.ulRef=void 0,this.personDetailsCompRef=void 0}mount(){var e=this;(0,n.sY)(this.ulRef,n.dy`
        loading
      ...
      ></app-person-details>
    `}}),(0,n.wA)({selector:"app-person-details"},o)}}]);