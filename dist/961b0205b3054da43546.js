var _initClass,_dec,_initClass2,_dec2,_initClass3,_dec3;function createAddInitializerMethod(e,t){return function(n){assertNotFinished(t,"addInitializer"),assertCallable(n,"An initializer"),e.push(n)}}function memberDec(e,t,n,i,a,r,s,o){var l;switch(a){case 1:l="accessor";break;case 2:l="method";break;case 3:l="getter";break;case 4:l="setter";break;default:l="field"}var c,u,p={kind:l,name:s?"#"+t:t,static:r,private:s},d={v:!1};0!==a&&(p.addInitializer=createAddInitializerMethod(i,d)),0===a?s?(c=n.get,u=n.set):(c=function(){return this[t]},u=function(e){this[t]=e}):2===a?c=function(){return n.value}:(1!==a&&3!==a||(c=function(){return n.get.call(this)}),1!==a&&4!==a||(u=function(e){n.set.call(this,e)})),p.access=c&&u?{get:c,set:u}:c?{get:c}:{set:u};try{return e(o,p)}finally{d.v=!0}}function assertNotFinished(e,t){if(e.v)throw new Error("attempted to call "+t+" after decoration was finished")}function assertCallable(e,t){if("function"!=typeof e)throw new TypeError(t+" must be a function")}function assertValidReturnValue(e,t){var n=typeof t;if(1===e){if("object"!==n||null===t)throw new TypeError("accessor decorators must return an object with get, set, or init properties or void 0");void 0!==t.get&&assertCallable(t.get,"accessor.get"),void 0!==t.set&&assertCallable(t.set,"accessor.set"),void 0!==t.init&&assertCallable(t.init,"accessor.init")}else if("function"!==n)throw new TypeError((0===e?"field":10===e?"class":"method")+" decorators must return a function or void 0")}function applyMemberDec(e,t,n,i,a,r,s,o){var l,c,u,p,d,m,h=n[0];if(s?l=0===a||1===a?{get:n[3],set:n[4]}:3===a?{get:n[3]}:4===a?{set:n[3]}:{value:n[3]}:0!==a&&(l=Object.getOwnPropertyDescriptor(t,i)),1===a?u={get:l.get,set:l.set}:2===a?u=l.value:3===a?u=l.get:4===a&&(u=l.set),"function"==typeof h)void 0!==(p=memberDec(h,i,l,o,a,r,s,u))&&(assertValidReturnValue(a,p),0===a?c=p:1===a?(c=p.init,d=p.get||u.get,m=p.set||u.set,u={get:d,set:m}):u=p);else for(var v=h.length-1;v>=0;v--){var f;void 0!==(p=memberDec(h[v],i,l,o,a,r,s,u))&&(assertValidReturnValue(a,p),0===a?f=p:1===a?(f=p.init,d=p.get||u.get,m=p.set||u.set,u={get:d,set:m}):u=p,void 0!==f&&(void 0===c?c=f:"function"==typeof c?c=[c,f]:c.push(f)))}if(0===a||1===a){if(void 0===c)c=function(e,t){return t};else if("function"!=typeof c){var g=c;c=function(e,t){for(var n=t,i=0;i<g.length;i++)n=g[i].call(e,n);return n}}else{var b=c;c=function(e,t){return b.call(e,t)}}e.push(c)}0!==a&&(1===a?(l.get=u.get,l.set=u.set):2===a?l.value=u:3===a?l.get=u:4===a&&(l.set=u),s?1===a?(e.push((function(e,t){return u.get.call(e,t)})),e.push((function(e,t){return u.set.call(e,t)}))):2===a?e.push(u):e.push((function(e,t){return u.call(e,t)})):Object.defineProperty(t,i,l))}function applyMemberDecs(e,t){for(var n,i,a=[],r=new Map,s=new Map,o=0;o<t.length;o++){var l=t[o];if(Array.isArray(l)){var c,u,p=l[1],d=l[2],m=l.length>3,h=p>=5;if(h?(c=e,0!=(p-=5)&&(u=i=i||[])):(c=e.prototype,0!==p&&(u=n=n||[])),0!==p&&!m){var v=h?s:r,f=v.get(d)||0;if(!0===f||3===f&&4!==p||4===f&&3!==p)throw new Error("Attempted to decorate a public method/accessor that has the same name as a previously decorated public method/accessor. This is not currently supported by the decorators plugin. Property name was: "+d);!f&&p>2?v.set(d,p):v.set(d,!0)}applyMemberDec(a,c,l,d,p,h,m,u)}}return pushInitializers(a,n),pushInitializers(a,i),a}function pushInitializers(e,t){t&&e.push((function(e){for(var n=0;n<t.length;n++)t[n].call(e);return e}))}function applyClassDecs(e,t){if(t.length>0){for(var n=[],i=e,a=e.name,r=t.length-1;r>=0;r--){var s={v:!1};try{var o=t[r](i,{kind:"class",name:a,addInitializer:createAddInitializerMethod(n,s)})}finally{s.v=!0}void 0!==o&&(assertValidReturnValue(10,o),i=o)}return[i,function(){for(var e=0;e<n.length;e++)n[e].call(i)}]}}function _applyDecs2203R(e,t,n){return{e:applyMemberDecs(e,t),get c(){return applyClassDecs(e,n)}}}import{Observable}from"rxjs";import styles from"./base.scss?inline";import{Component,html,Injectable,registerRouterComponent,render,Renderer,Subscriptions}from"./lib";import{matchPath,Router}from"./lib/router";let _TestService,_TestComponent,_AppComponent;registerRouterComponent(),_dec=Injectable();class TestService{getGreeting(){return"hello world"}}[_TestService,_initClass]=_applyDecs2203R(TestService,[],[_dec]).c,_initClass(),_dec2=Component({selector:"test-ele",deps:[Renderer]});class TestComponent{constructor(e){this.inputVal=""}emitDataToParent(){this.renderer.emitEvent("customoutput",{greet:"greetings from child"})}handleInput(e){const t=e.target.value;console.log(t),this.inputVal=t}render(){var e=this;return html`
